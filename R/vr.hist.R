...
#' @param reliability logical; if \code{TRUE} the reliability index is calculated for the plot (see details); if \code{FALSE} the reliability index is not calculated; default: \code{FALSE}
...
#'
#' An uniform VRH indicates a calibrated predictive distribution. A ∩-shape in the
...
#' @export
vr.hist <- function (y, x, bins = NULL, type = "relative", title = "Verification Rank Histogram", reliability = FALSE, entropy = FALSE, na.rm = TRUE) {
